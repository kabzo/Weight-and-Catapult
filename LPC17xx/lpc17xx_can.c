...
{
    uint32_t result = 0;
    uint8_t NT=0, TSEG1=0, TSEG2=0, BRFail=0; /*YOONGHM*/
    uint32_t CANPclk = 0;
    uint32_t BRP = 0; /*YOONGHM*/
...
{
    uint16_t tmp = 0;
    uint32_t buf0 = 0, buf1 = 0, entry1 = 0, entry2 = 0, LID = 0, UID = 0; /*YOONGHM*/
